...
final class PermissionCatalog
{
    ...
    public static function definitions(): array
    {
        return [
            ...
            ['group' => 'Finance', 'slug' => 'finance.settlements', 'name' => 'Bank settlements', 'description' => 'Match card, QR, transfer and cash takings against bank statements and cash handed over'],
