    ...
    private static function build(): array
    {
        ...
        $defs = [
            ...
            new BlockTypeDefinition(
                ...
                description: 'Home footer with contact chat links and thanks line. Independent of the site-wide legal footer.',
                apps: self::BOTH,
                removable: true,
                supportsSharedContent: true,
                settingsSchema: $deviceSchema,
                settingsDefaults: $deviceDefaults,
                flowWarning: 'Removing the brand footer hides contact shortcuts on Home. Site-wide legal links still appear in the Website layout footer.',
            ),
            new BlockTypeDefinition(
                type: 'rich_text',
                label: 'Custom text',
