        ...
        foreach (BusinessDetailsKeys::SECTIONS as $id => $keys) {
            $sections[] = [
                ...
                'description' => match ($id) {
                    'identity' => 'Trading name and website address. Legal name is under Legal, tax & documents (GST).',
                    'address' => 'Shared operational address and maps links — not Website/Order App marketing layouts.',
                    'contact' => 'Phone, email and chat links for the shared business record. Change them once here and receipts, signage, the website and the order app all follow.',
                    'brand' => 'Your logo, colour, tagline and images. One set for the whole business — receipts, invoices, TV signage, the website and the order app.',
