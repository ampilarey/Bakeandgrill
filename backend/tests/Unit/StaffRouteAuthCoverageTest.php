...
class StaffRouteAuthCoverageTest extends TestCase
{
    ...
    private const ALLOWLIST = [
        ...
        'PUT api/pos/quick-keys' => 'api/pos/quick-keys — any signed-in staff; writes only the caller\'s own Quick tabs (PosQuickKeyController::updateMine); the shared layout is a separate route gated on menu.manage',
        'GET api/pos/quick-keys/sources' => 'api/pos/quick-keys/sources — any signed-in staff; names of cashiers with Quick tabs to copy (a layout is a list of menu items, nothing private)',
        'POST api/pos/quick-keys/copy' => 'api/pos/quick-keys/copy — any signed-in staff; copies another cashier\'s Quick tabs onto the caller\'s own layout only',
