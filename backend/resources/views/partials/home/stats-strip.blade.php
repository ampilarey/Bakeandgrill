{{--
    Public "social proof" counters — owner-enabled in Settings → Public stats.
    Values come rounded ("12,500+") from PublicSiteStats; renders nothing
...
<section class="stats-strip" data-testid="public-stats">
    <div class="stats-strip-inner">
        @foreach($publicStats['stats'] as $stat)
