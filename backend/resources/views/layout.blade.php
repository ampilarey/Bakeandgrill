...
<body>
{{-- TEMP indigo-hook proof on TEST only — remove after confirmation --}}
@if(str_contains((string) config('app.url'), 'test.bakeandgrill.mv'))
<div id="auto-deploy-live-test" style="position:relative;z-index:9999;background:#312e81;color:#e0e7ff;text-align:center;padding:0.7rem 1rem;font:600 0.95rem/1.3 system-ui,sans-serif;">
    INDIGO HOOK · CODE <span style="color:#a5b4fc;">INDIGO-AUTHZ-1102</span> · authz merge auto-pull test
</div>
@endif
@if($gtmId !== '')
