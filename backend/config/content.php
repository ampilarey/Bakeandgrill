...
return [
    'blocks' => [
        ...
        'menu_page_subtitle' => [
            ...
            'rich' => false,
            'validate' => 'nullable|string|max:5000',
            'default' => 'Browse and add items to your cart',
        ],
        'menu_page_title' => [
        ...
        'order_status_closed' => [
            ...
            'rich' => false,
            'validate' => 'nullable|string|max:5000',
            'default' => 'Online ordering is closed',
        ],
        'order_status_closes' => [
            'label' => 'Menu banner — Closes {time}',
            'group' => 'Status banners',
            'type' => 'text',
            'apps' => ['order_app'],
            'shareable' => false,
        ...
        'order_status_delivery_from' => [
            'label' => 'Menu banner — Delivery from {time}',
            'group' => 'Status banners',
            'type' => 'text',
            'apps' => ['order_app'],
            'shareable' => false,
            ...
            'rich' => false,
            'validate' => 'nullable|string|max:5000',
            'default' => 'Delivery from {time}',
        ],
        'order_status_open' => [
            'label' => 'Menu banner — Open',
            'group' => 'Status banners',
            'type' => 'text',
            'apps' => ['order_app'],
            'shareable' => false,
            ...
            'rich' => false,
            'validate' => 'nullable|string|max:5000',
            'default' => 'Online ordering is open',
        ],
        'order_status_opens' => [
            'label' => 'Menu banner — Opens {time}',
            'group' => 'Status banners',
            'type' => 'text',
            'apps' => ['order_app'],
            'shareable' => false,
