...
echo "  [ ] POS Sync panel: failed + conflict rows have Retry/Discard/Edit in cart"
echo "  [ ] POS Active orders: aged tickets sorted critical → warn → ok"
echo "  [ ] Gift card: buy → SMS/email → redeem online/POS → refund restores balance"
echo "  [ ] Gift card success page: Resend SMS/email within 48h"
echo "  [ ] POS offline: gift card charge blocked until reconnect"
