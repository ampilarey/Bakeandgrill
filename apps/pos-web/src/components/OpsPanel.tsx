    ...
    <>
      <section className="col-span-6 space-y-4">
          ...
          {ops.shift ? (
            <div className="mt-3 space-y-2 text-sm text-slate-600">
              ...
              {ops.shift.closed_at ? (
                ...
                <>
                  <label className="block text-xs text-slate-500">Closing Cash</label>
                  <input
            ...
            <div className="mt-3 space-y-2">
              <label className="block text-xs text-slate-500">Opening Cash</label>
              <input
                className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm"
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm">
          ...
          <div className="mt-3 space-y-2">
            ...
            <input className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm" placeholder="Reason"
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm">
          ...
          <div className="mt-3 space-y-2">
            ...
            <input className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm" placeholder="Quantity (+/-)"
              value={ops.adjustQuantity} onChange={(e) => ops.setAdjustQuantity(e.target.value)} />
            <input className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm" placeholder="Notes"
      ...
      <section className="col-span-6 space-y-4">
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm">
          ...
          <button className="w-full mt-3 rounded-lg border border-slate-200 py-2 text-sm font-semibold text-slate-700"
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm">
          ...
          <div className="mt-3 space-y-2">
            <input className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm" placeholder="Supplier name"
              value={ops.newSupplierName} onChange={(e) => ops.setNewSupplierName(e.target.value)} />
            <input className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm" placeholder="Phone (optional)"
            ...
            {ops.suppliers.length > 0 && (
              <div className="text-xs text-slate-500">{ops.suppliers.map((s) => s.name).join(", ")}</div>
            )}
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm">
          ...
          <div className="mt-3 space-y-2">
            ...
            <input className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm" placeholder="Item name"
            ...
            <input className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm" placeholder="Unit cost"
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm">
          ...
          <div className="mt-3 space-y-2">
            <input className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm" placeholder="Order ID"
            ...
            <input className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm" placeholder="Reason (optional)"
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm">
          ...
          <div className="mt-3 space-y-2">
            <textarea className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm" rows={4}
            ...
            <div className="grid grid-cols-2 gap-2">
              <button className="rounded-lg border border-slate-200 py-2 text-sm font-semibold text-slate-700"
                onClick={ops.handlePreviewPromotion}>Preview</button>
              <button className="rounded-lg bg-slate-900 text-white py-2 text-sm font-semibold"
