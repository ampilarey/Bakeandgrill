...
export async function updateAdminCustomer(
  id: number,
  data: Partial<Pick<AdminCustomer, 'name' | 'email' | 'internal_notes' | 'is_active' | 'sms_opt_out' | 'tin' | 'is_gst_registered' | 'billing_address'>> & { date_of_birth?: string | null },
...
export async function fetchLoyaltyLedger(
  customerId: number
): Promise<{ data: Array<{ id: number; delta: number; reason: string; order_id?: number | null; order_number?: string | null; created_at: string }> }> {
