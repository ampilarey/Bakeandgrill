  ...
  return (
    <div>
      ...
      <p style={{ margin: '0 0 16px', fontSize: 13, color: '#6B5D4F', lineHeight: 1.45 }}>
        Open, close, split, and merge tables on the <strong>POS</strong> — this page is for layout setup and live status.
      </p>
      ...
      {loading ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap', padding: '12px 16px', background: '#fff', border: '1px solid #E8E0D8', borderRadius: 12 }}>
            ...
            <span style={{ fontSize: 12, color: '#9C8E7E', marginLeft: 'auto' }}>Read-only floor status</span>
          </div>
