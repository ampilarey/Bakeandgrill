...
export const HOME_COMPONENT_LIBRARY: LibraryComponent[] = [
  ...
  { type: 'proof', name: 'Social proof', summary: 'Stats and trust numbers.', supportsSharedContent: true },
  {
    type: 'reviews',
  ...
  { type: 'cta', name: 'Call-to-action band', summary: 'Hungry? style order banner.', supportsSharedContent: true },
  { type: 'location', name: 'Location / map', summary: 'Address, map, and directions.', supportsSharedContent: true },
  {
    type: 'events_band',
  ...
  { type: 'image_text', name: 'Image with text', summary: 'Picture beside heading and paragraph.', supportsSharedContent: true, allowsMultiple: true },
  { type: 'video', name: 'Video', summary: 'Silent looping video.', supportsSharedContent: true, allowsMultiple: true },
  { type: 'button_band', name: 'Button band', summary: 'Text with up to two buttons.', supportsSharedContent: true, allowsMultiple: true },
  { type: 'faq_list', name: 'FAQ', summary: 'Questions and answers.', supportsSharedContent: true, allowsMultiple: true },
