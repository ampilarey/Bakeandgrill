...
const KEY_HELPERS: Record<string, string> = {
  ...
  delivery_threshold: 'Marketing copy for free-delivery promise (e.g. “MVR 200”). The real fee threshold used at checkout is Delivery & Zones → Free delivery threshold.',
  ...
  hero_slides: 'Full-width banners at the top of the home page (image or muted video).',
  section_hero_enabled: 'Turn the hero banners on or off.',
  ...
  section_reviews_enabled: 'Show or hide the reviews section on the order app.',
