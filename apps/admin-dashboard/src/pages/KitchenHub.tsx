...
export function kitchenTabs(canManage: boolean): HubTab[] {
  return [
    ...
    { id: 'customers', group: 'Plan', label: 'Customer demand', permissions: PLAN, desc: 'What registered customers add to demand', render: () => <PlanCustomersTab /> },
    ...
    { id: 'waste', group: 'Handover', label: 'Waste & remakes', permissions: REPORTS, desc: 'Production waste and remakes — stock write-offs are under Inventory → Waste logs', render: () => <KitchenProductionPage tab="waste" /> },
