...
export const GRID_COLUMNS: GridColumn[] = [
  ...
  { key: 'tomorrow_daily_capacity', label: 'Max per day', group: 'Kitchen', kind: 'int', field: 'tomorrow_daily_capacity', width: 100, defaultOn: false, sortValue: (i) => numOf(i.tomorrow_daily_capacity) },
  { key: 'min_order_qty', label: 'Min per order', group: 'Kitchen', kind: 'int', field: 'min_order_qty', width: 100, defaultOn: false, sortValue: (i) => numOf(i.min_order_qty) },
  { key: 'lead_time_hours', label: 'Notice (h)', group: 'Kitchen', kind: 'int', field: 'lead_time_hours', width: 90, defaultOn: false, sortValue: (i) => numOf(i.lead_time_hours) },
