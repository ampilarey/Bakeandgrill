import {
  ...
  Boxes, LayoutGrid, Wallet, Clock, Monitor, Share2, Globe,
...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/settings/public-stats', icon: Globe, label: 'Public Stats', permissions: ['settings.update', 'website.manage'], description: 'Counters on website & order app' },
