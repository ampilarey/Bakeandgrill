...
const VALUES = [
  ...
  { initial: 'C', title: 'Community First', desc: 'We are part of Malé — we know our customers and they know us.' },
  { initial: 'Q', title: 'Quality Always', desc: "Whether it's a cup of tea or a full grill, everything gets the same care." },
  { initial: 'B', title: 'Built for Today', desc: 'Online ordering, table reservations, loyalty rewards — all in one place.' },
];
  ...
  return (
    <div style={{ maxWidth: '860px', margin: '0 auto', padding: '3rem 1.5rem' }}>
      ...
      <section style={{ background: 'var(--color-surface-alt)', borderRadius: '20px', padding: '2.5rem', marginBottom: '2rem' }}>
        ...
        <p style={{ color: 'var(--color-text)', fontSize: '1rem', lineHeight: 1.8, marginBottom: '1rem' }}>
