...
function bgStyle(slide: SignageSlide, theme: SignageTheme): React.CSSProperties {
...
function SignageEl({
  ...
  switch (el.type) {
    ...
    case 'image': {
      ...
      body = url
        ? <img src={url} alt="" style={{ width: '100%', height: '100%', objectFit: (style.objectFit as React.CSSProperties['objectFit']) || 'cover' }} onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }} />
        : null;
      break;
    }
    case 'video': {
