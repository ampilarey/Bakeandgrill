...
const styles = {
  card:         { background: 'var(--color-surface)', borderRadius: '16px', padding: '18px 20px', marginBottom: 0, boxShadow: 'var(--shadow-sm)', border: '1px solid var(--color-border)' },
  sectionTitle: { fontSize: 'var(--text-md)', fontWeight: 700, color: 'var(--color-primary)', marginBottom: '0.75rem', paddingBottom: '0.625rem', borderBottom: '1px solid var(--color-border)' },
