...
const TRANSLATIONS: Translations = {
  ...
  "home.corp_name_required":   { en: "Name and phone are required.",  dv: "Name and phone are required." },
  "home.corp_min_guests":      { en: "Minimum {n} guests for office orders.", dv: "Minimum {n} guests for office orders." },
  "home.corp_ph_name":         { en: "Your name *",                   dv: "Your name *" },
  "home.corp_ph_phone":        { en: "Phone *",                       dv: "Phone *" },
  "home.corp_ph_company":      { en: "Company / organisation",        dv: "Company / organisation" },
  "home.corp_ph_headcount":    { en: "Headcount (min {n})",           dv: "Headcount (min {n})" },
  "home.corp_ph_notes":        { en: "Event date, dietary needs, delivery address…", dv: "Event date, dietary needs, delivery address…" },
  "home.corp_sending":         { en: "Sending…",                      dv: "Sending…" },
  "home.corp_submit":          { en: "Request a quote →",             dv: "Request a quote →" },
  "home.mode_region":          { en: "Choose order mode",             dv: "Choose order mode" },
  ...
  "checkout.empty_cart":         { en: "Your cart is empty. Add some items first.", dv: "Your cart is empty. Add some items first." },
  "checkout.browse_menu":        { en: "Browse the menu",              dv: "Browse the menu" },
  "checkout.processing":         { en: "Processing…",                  dv: "Processing…" },
  "checkout.gate_closed":        { en: "Online ordering is closed",    dv: "Online ordering is closed" },
  "checkout.gate_closed_sub":    { en: "Online ordering is currently unavailable. Please check back later.", dv: "Online ordering is currently unavailable. Please check back later." },
  "checkout.place_no_payment":   { en: "Place order — no payment due", dv: "Place order — no payment due" },
  "checkout.pay_bml":            { en: "Pay MVR {amount} with BML",    dv: "Pay MVR {amount} with BML" },
  "checkout.asap":               { en: "ASAP",                         dv: "ASAP" },
  "checkout.terms_prefix":       { en: "I agree to the",               dv: "I agree to the" },
  "checkout.terms_and":          { en: ", and",                        dv: ", and" },
  "checkout.whatsapp_help":      { en: "Message us on WhatsApp",       dv: "Message us on WhatsApp" },
  "checkout.referral_pending":   { en: "Referral discount is estimated — final amount confirmed when your order is created.", dv: "Referral discount is estimated — final amount confirmed when your order is created." },
  "checkout.kitchen_wait":       { en: "Kitchen wait ~{n} min",        dv: "Kitchen wait ~{n} min" },
  "checkout.hi_name":            { en: "Hi, {name}",                   dv: "Hi, {name}" },
  "checkout.contact_whatsapp":   { en: "Contact us on WhatsApp",       dv: "Contact us on WhatsApp" },
  "checkout.contact_viber":      { en: "Contact us on Viber",          dv: "Contact us on Viber" },
  ...
  "orders.recent_title":   { en: "Recent orders",                                        dv: "Recent orders" },
  "orders.see_all":        { en: "See all orders →",                                     dv: "See all orders →" },
  "orders.none_recent":    { en: "No recent orders yet",                                 dv: "No recent orders yet" },
  "orders.reorder_added":  { en: "{n} item(s) added to cart",                            dv: "{n} item(s) added to cart" },
  "orders.reorder_fail":   { en: "Could not load that order. Please try again.",         dv: "Could not load that order. Please try again." },
