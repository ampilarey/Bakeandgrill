...
Status: **Historical archive — agent prompt, not a product plan.** Rescued for history only.

> Rescued from branch `claude/website-review-audit-gwuJu` (not written fresh on this branch).
