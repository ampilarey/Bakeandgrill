...
Status: **Built.** `default_item_image` content/site setting and menu/home fallbacks are live. Body is design history for shipped behaviour.

> Rescued from branch `claude/default-item-image-plan` (not written fresh on this branch).
