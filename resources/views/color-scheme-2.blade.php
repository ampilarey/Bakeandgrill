...
<head>
    ...
    <title>Bake & Grill - Color Scheme 2: Sage & Terracotta</title>
    <meta name="description" content="Bake & Grill - Authentic Dhivehi Cuisine. Color Scheme 2: Sage & Terracotta.">
    ...
    <style>
        * {
        ...
        :root {
            ...
            --text-dark: #2F4F2F;
            --text-light: #556B55;
            --bg-gradient: linear-gradient(135deg, #FDF5E6 0%, #F5DEB3 50%, #DEB887 100%);
            --glass-bg: rgba(253, 245, 230, 0.25);
            --glass-border: rgba(253, 245, 230, 0.18);
        }
        ...
        .opening-badge {
            ...
            font-weight: 600;
            margin-bottom: 3rem;
            box-shadow: 0 10px 30px rgba(107, 142, 107, 0.3);
...
<body>
    <div class="color-nav">
        ...
        <a href="{{ route('color-scheme-2') }}" class="active">2. Sage & Terracotta</a>
    ...
    <div class="scheme-badge">Scheme #2</div>
    ...
    <div class="container">
        <div class="content-side">
            <div class="logo-section">
                <div class="logo">
                    <svg width="150" height="150" viewBox="0 0 150 150" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <circle cx="75" cy="75" r="70" fill="url(#bgGradient)" stroke="#556B55" stroke-width="3"/>
                        ...
                        <ellipse cx="75" cy="75" rx="35" ry="20" fill="url(#logoGradient)" stroke="#6B8E6B" stroke-width="2"/>
                        ...
                        <ellipse cx="60" cy="35" rx="8" ry="5" fill="#F5DEB3" transform="rotate(-20 60 35)"/>
                        <ellipse cx="75" cy="32" rx="8" ry="5" fill="#F5DEB3" transform="rotate(0 75 32)"/>
                        <ellipse cx="90" cy="35" rx="8" ry="5" fill="#F5DEB3" transform="rotate(20 90 35)"/>
            ...
            <div class="opening-badge">Color Scheme 2</div>
            ...
            <div class="color-info">
                <h4>Sage & Terracotta</h4>
                <div class="color-palette">
                    <div class="color-swatch" style="background: #6B8E6B;"></div>
                    <div class="color-swatch" style="background: #CD853F;"></div>
                    <div class="color-swatch" style="background: #F5DEB3;"></div>
                    <div class="color-swatch" style="background: #FDF5E6;"></div>
                </div>
                <div class="color-names">
                    Primary: Sage Green (#6B8E6B)<br>
                    Secondary: Peru/Terracotta (#CD853F)<br>
                    Accent: Wheat (#F5DEB3)<br>
                    Background: Old Lace (#FDF5E6)
                </div>
            </div>
        </div>
