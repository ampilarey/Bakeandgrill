...
<head>
    ...
    <title>Bake & Grill - Color Scheme 5: Forest & Cream</title>
    <meta name="description" content="Bake & Grill - Authentic Dhivehi Cuisine. Color Scheme 5: Forest & Cream.">
    ...
    <style>
        * {
        ...
        :root {
            ...
            --text-dark: #2E8B57;
            --text-light: #556B2F;
            --bg-gradient: linear-gradient(135deg, #FFFAF0 0%, #F5F5DC 50%, #F0E68C 100%);
            --glass-bg: rgba(255, 250, 240, 0.25);
            --glass-border: rgba(255, 250, 240, 0.18);
        }
...
<body>
    <div class="color-nav">
        ...
        <a href="{{ route('color-scheme-5') }}" class="active">5. Forest & Cream</a>
    ...
    <div class="scheme-badge">Scheme #5</div>
    ...
    <div class="container">
        <div class="content-side">
            <div class="logo-section">
                <div class="logo">
                    <svg width="150" height="150" viewBox="0 0 150 150" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <circle cx="75" cy="75" r="70" fill="url(#bgGradient)" stroke="#1E7B1E" stroke-width="3"/>
                        ...
                        <ellipse cx="75" cy="75" rx="35" ry="20" fill="url(#logoGradient)" stroke="#228B22" stroke-width="2"/>
                        ...
                        <ellipse cx="60" cy="35" rx="8" ry="5" fill="#F5F5DC" transform="rotate(-20 60 35)"/>
                        <ellipse cx="75" cy="32" rx="8" ry="5" fill="#F5F5DC" transform="rotate(0 75 32)"/>
                        <ellipse cx="90" cy="35" rx="8" ry="5" fill="#F5F5DC" transform="rotate(20 90 35)"/>
            ...
            <div class="opening-badge">Color Scheme 5</div>
            ...
            <div class="color-info">
                ...
                <div class="color-palette">
                    ...
                    <div class="color-swatch" style="background: #8FBC8F;"></div>
                    <div class="color-swatch" style="background: #F5F5DC;"></div>
                    <div class="color-swatch" style="background: #FFFAF0;"></div>
                </div>
                <div class="color-names">
                    Primary: Forest Green (#228B22)<br>
                    Secondary: Dark Sea Green (#8FBC8F)<br>
                    Accent: Beige (#F5F5DC)<br>
