...
<head>
    ...
    <title>Bake & Grill - Color Scheme 4: Burnt Orange & Navy</title>
    <meta name="description" content="Bake & Grill - Authentic Dhivehi Cuisine. Color Scheme 4: Burnt Orange & Navy.">
    ...
    <style>
        * {
        ...
        :root {
            ...
            --text-dark: #1C1C1C;
            --text-light: #333333;
            --bg-gradient: linear-gradient(135deg, #FFFEF7 0%, #FFF8DC 50%, #F5DEB3 100%);
            --glass-bg: rgba(255, 254, 247, 0.25);
            --glass-border: rgba(255, 254, 247, 0.18);
        }
...
<body>
    <div class="color-nav">
        ...
        <a href="{{ route('color-scheme-4') }}" class="active">4. Burnt Orange & Navy</a>
    ...
    <div class="scheme-badge">Scheme #4</div>
    ...
    <div class="container">
        <div class="content-side">
            <div class="logo-section">
                <div class="logo">
                    <svg width="150" height="150" viewBox="0 0 150 150" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <circle cx="75" cy="75" r="70" fill="url(#bgGradient)" stroke="#B04500" stroke-width="3"/>
                        ...
                        <ellipse cx="75" cy="75" rx="35" ry="20" fill="url(#logoGradient)" stroke="#CC5500" stroke-width="2"/>
                        ...
                        <ellipse cx="60" cy="35" rx="8" ry="5" fill="#FFD700" transform="rotate(-20 60 35)"/>
                        <ellipse cx="75" cy="32" rx="8" ry="5" fill="#FFD700" transform="rotate(0 75 32)"/>
                        <ellipse cx="90" cy="35" rx="8" ry="5" fill="#FFD700" transform="rotate(20 90 35)"/>
            ...
            <div class="opening-badge">Color Scheme 4</div>
            ...
            <div class="color-info">
                <h4>Burnt Orange & Navy</h4>
                <div class="color-palette">
                    <div class="color-swatch" style="background: #CC5500;"></div>
                    <div class="color-swatch" style="background: #191970;"></div>
                    <div class="color-swatch" style="background: #FFD700;"></div>
                    <div class="color-swatch" style="background: #FFFEF7;"></div>
                </div>
                <div class="color-names">
                    Primary: Burnt Orange (#CC5500)<br>
                    Secondary: Midnight Blue (#191970)<br>
                    Accent: Gold (#FFD700)<br>
                    Background: Floral White (#FFFEF7)
                </div>
            </div>
        </div>
