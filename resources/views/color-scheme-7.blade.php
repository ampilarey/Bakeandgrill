...
<head>
    ...
    <title>Bake & Grill - Color Scheme 7: Deep Teal & Mustard</title>
    <meta name="description" content="Bake & Grill - Authentic Dhivehi Cuisine. Color Scheme 7: Deep Teal & Mustard.">
    ...
    <style>
        * {
        ...
        :root {
            ...
            --text-dark: #2F4F4F;
            --text-light: #556B6B;
            --bg-gradient: linear-gradient(135deg, #FFFEF0 0%, #F5F5DC 50%, #F0E68C 100%);
            --glass-bg: rgba(255, 254, 240, 0.25);
            --glass-border: rgba(255, 254, 240, 0.18);
        }
...
<body>
    <div class="color-nav">
        ...
        <a href="{{ route('color-scheme-7') }}" class="active">7. Deep Teal & Mustard</a>
        <a href="{{ route('home') }}">Original</a>
    </div>
    
    <div class="scheme-badge">Scheme #7</div>
    ...
    <div class="container">
        <div class="content-side">
            <div class="logo-section">
                <div class="logo">
                    <svg width="150" height="150" viewBox="0 0 150 150" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <circle cx="75" cy="75" r="70" fill="url(#bgGradient)" stroke="#006666" stroke-width="3"/>
                        ...
                        <ellipse cx="75" cy="75" rx="35" ry="20" fill="url(#logoGradient)" stroke="#008B8B" stroke-width="2"/>
            ...
            <div class="opening-badge">Color Scheme 7</div>
