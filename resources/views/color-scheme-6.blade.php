...
<head>
    ...
    <title>Bake & Grill - Color Scheme 6: Warm Gray & Copper</title>
    <meta name="description" content="Bake & Grill - Authentic Dhivehi Cuisine. Color Scheme 6: Warm Gray & Copper.">
    ...
    <style>
        * {
        ...
        :root {
            ...
            --text-dark: #2F2F2F;
            --text-light: #555555;
            --bg-gradient: linear-gradient(135deg, #F5F5F5 0%, #E6E6E6 50%, #D3D3D3 100%);
            --glass-bg: rgba(245, 245, 245, 0.25);
            --glass-border: rgba(245, 245, 245, 0.18);
        }
...
<body>
    <div class="color-nav">
        ...
        <a href="{{ route('color-scheme-6') }}" class="active">6. Warm Gray & Copper</a>
        <a href="{{ route('color-scheme-7') }}">7. Deep Teal & Mustard</a>
        <a href="{{ route('home') }}">Original</a>
    </div>
    
    <div class="scheme-badge">Scheme #6</div>
    ...
    <div class="container">
        <div class="content-side">
            <div class="logo-section">
                <div class="logo">
                    <svg width="150" height="150" viewBox="0 0 150 150" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <circle cx="75" cy="75" r="70" fill="url(#bgGradient)" stroke="#5A6B7D" stroke-width="3"/>
                        ...
                        <ellipse cx="75" cy="75" rx="35" ry="20" fill="url(#logoGradient)" stroke="#708090" stroke-width="2"/>
            ...
            <div class="opening-badge">Color Scheme 6</div>
            ...
            <div class="color-info">
                <h4>Warm Gray & Copper</h4>
                <div class="color-palette">
                    <div class="color-swatch" style="background: #708090;"></div>
                    <div class="color-swatch" style="background: #B87333;"></div>
                ...
                <div class="color-names">
                    Primary: Slate Gray (#708090)<br>
                    Secondary: Copper (#B87333)<br>
